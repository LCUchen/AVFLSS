...
class EncryptedNumber(object):
    ...
    def obfuscate(self):
        ...
        # self.__ciphertext = int(self.__ciphertext) * r_pow_n % self.public_key.nsquare
    ...
    def _raw_add(self, e_a, e_b):
        ...
        # e_a = Decimal(e_a)
        # e_b = Decimal(e_b)
        # nsquare = Decimal(self.public_key.nsquare)
        # return eval(str(e_a * e_b % nsquare))
        try:
            res = e_a * e_b % self.public_key.nsquare
        except:
            print(type(e_a), e_a)
            print(type(e_b), e_b)
            print(type(self.public_key.nsquare), self.public_key.nsquare)
        return res
